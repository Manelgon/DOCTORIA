            ...
            <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-blue-100">
                ...
                <form action={login} className="space-y-6 mt-8" autoComplete="off">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            name="email"
                            type="email"
                            placeholder="doctor@doctoria.es"
                            required
                            autoComplete="off"
                ...
                <div className="text-center mt-8 pt-4 border-t border-slate-100">
                    <p className="text-sm text-slate-500">
                        ¿Es usted un paciente? <br />
                        <Link href="/login/pacientes" className="text-blue-600 font-semibold hover:underline inline-flex items-center mt-1">
                            Acceda al Portal de Pacientes <ArrowRight className="ml-1 h-3 w-3" />
                        </Link>
                    </p>
                </div>
            </div>
